...
if [ $ENVIRONMENT = "QA" ];then
	 sshpass -p "root" scp target/gamutgurus.war neeraj@172.17.0.5:/home/gamut/Distro/apache-tomcat-8.5.56/webapps
        ...
        sshpass -p "root" scp target/gamutgurus.war neeraj@172.17.0.6:/home/gamut/Distro/apache-tomcat-8.5.56/webapps
